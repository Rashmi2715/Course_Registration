...
public String enrollCourse(@PathVariable Long courseId, HttpSession session, Model model) {
...
public String enrollInCourse(@PathVariable Long courseId, HttpSession session, RedirectAttributes redirectAttributes) {
    ...
    Student student = studentRepository.findByEmailWithCourses(sessionStudent.getEmail());
...
public String viewEnrolledCourses(HttpSession session, Model model) {
    ...
    Student fullStudent = studentRepository.findByEmailWithCourses(student.getEmail());
    System.out.println("Enrolled courses for student: " + fullStudent.getCourses().size());
